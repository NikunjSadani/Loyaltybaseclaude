...
function mapBackendInvoice(b: BackendInvoice): InvoiceListItem {
  return {
    ...
    description:   b.snapshot?.description ?? `Payment for Marketing and support services for the month of ${formatPeriodLabel(b.period)}`,
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 flex gap-3">
          ...
          <div className="flex-1 text-xs text-blue-700">
            ...
            <p>
              ...
              your behalf for marketing and support services you have provided. No signature
