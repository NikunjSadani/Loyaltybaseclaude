...
`cd platform && npx tsc --noEmit`. **Latest green (develop HEAD, cutover #30): api jest 2329 · nest 0 · FE tsc 0 · FE vitest 2143.** (prod = main = develop = `7e7ff4e` = #30, LIVE + VERIFIED 2026-08-14.)
