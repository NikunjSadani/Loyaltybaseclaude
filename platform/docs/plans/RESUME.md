...
`cd platform && npx tsc --noEmit`. **Latest green (develop HEAD, cutover #31): api jest 2362 · nest 0 · FE tsc 0 · FE vitest 2150.** (prod = main = develop = `0fc80c6` = #31, LIVE + VERIFIED 2026-08-14.)
