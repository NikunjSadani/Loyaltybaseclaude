...
- **prod SERVES `f193127` (cutover #18, 2026-07-30); main == `f193127`.** *(history: `52fc19f` #17, `bda9bf3` #15.)* Cutover #18 = **scheme prefill Editable/Locked** (backend-enforced Excel-variable prefill; code-only, no migration) — additive + dormant, staging-verified end-to-end; memory [[scheme-data-collection]] §16.
