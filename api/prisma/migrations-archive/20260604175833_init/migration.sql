-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('GIFSY_ADMIN', 'CLIENT_ADMIN', 'MIS_USER', 'SALES_HO', 'SALES_STATE_HEAD', 'SALES_ASM', 'SALES_SO', 'SALES_ISR', 'RETAILER', 'WHOLESALER', 'SUB_STOCKIST');
...
-- CreateEnum
CREATE TYPE "KycStatus" AS ENUM ('DRAFT', 'SUBMITTED', 'UNDER_REVIEW', 'PENDING_PENNY_DROP', 'PENDING_AGREEMENT', 'PENDING_SO_APPROVAL', 'PENDING_ASM_APPROVAL', 'PENDING_RSM_APPROVAL', 'PENDING_GIFSY', 'APPROVED', 'REJECTED', 'RE_UPLOAD_REQUIRED', 'RESUBMISSION_REQUIRED', 'RE_KYC_REQUIRED', 'SUSPENDED');
...
-- CreateIndex
CREATE INDEX "channel_partner_classes_clientId_idx" ON "channel_partner_classes"("clientId");
...
-- CreateIndex
CREATE INDEX "skus_clientId_idx" ON "skus"("clientId");
...
-- CreateIndex
CREATE INDEX "sales_uploads_clientId_idx" ON "sales_uploads"("clientId");
...
-- CreateIndex
CREATE UNIQUE INDEX "sales_invoices_clientId_invoiceNumber_key" ON "sales_invoices"("clientId", "invoiceNumber");
